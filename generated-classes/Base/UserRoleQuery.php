 ...
 *
 * @method     \UserQuery|\RoleQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class UserRoleQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'FusionCore', $modelName = '\\UserRole', $modelAlias = null)
    {
