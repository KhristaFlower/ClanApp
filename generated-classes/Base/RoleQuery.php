 ...
 *
 * @method     \UserRoleQuery|\RolePermissionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class RoleQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'FusionCore', $modelName = '\\Role', $modelAlias = null)
    {
