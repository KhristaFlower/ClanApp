...
use \RolePermission as ChildRolePermission;
use \RolePermissionQuery as ChildRolePermissionQuery;
use \Exception;
use \PDO;
use Map\RolePermissionTableMap;
 ...
 *
 * @method     \PermissionQuery|\RoleQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class RolePermissionQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\RolePermissionQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'FusionCore', $modelName = '\\RolePermission', $modelAlias = null)
    {
