...
abstract class RolePermission implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\RolePermissionTableMap';
    ...
    /**
     * Initializes internal state of Base\RolePermission object.
     */
     ...
     * @return $this|\RolePermission The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\RolePermission'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \RolePermission (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \RolePermission Clone of current object.
     * @throws PropelException
     */
