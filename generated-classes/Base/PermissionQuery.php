 ...
 *
 * @method     \RolePermissionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PermissionQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'FusionCore', $modelName = '\\Permission', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \RolePermission object
     *
     * @param \RolePermission|ObjectCollection $rolePermission the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    public function filterByRolePermission($rolePermission, $comparison = null)
    {
        if ($rolePermission instanceof \RolePermission) {
            ...
            throw new PropelException('filterByRolePermission() only accepts arguments of type \RolePermission or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \RolePermissionQuery A secondary query class using the current class as primary query
     */
    public function useRolePermissionQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'RolePermission', '\RolePermissionQuery');
    }
