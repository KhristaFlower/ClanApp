...
abstract class Role implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ClanApp\\entities\\Map\\RoleTableMap';
    ...
    /**
     * Initializes internal state of ClanApp\entities\Base\Role object.
     */
     ...
     * @return $this|\ClanApp\entities\Role The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\ClanApp\\entities\\Role'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ClanApp\entities\Role
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ClanApp\entities\Role The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ClanApp\entities\Role (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ClanApp\entities\Role Clone of current object.
     * @throws PropelException
     */
