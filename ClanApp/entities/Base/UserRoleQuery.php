...
use ClanApp\entities\Map\UserRoleTableMap;
 ...
 *
 * @method     \ClanApp\entities\UserQuery|\ClanApp\entities\RoleQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class UserRoleQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \ClanApp\entities\Base\UserRoleQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'FusionCore', $modelName = '\\ClanApp\\entities\\UserRole', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = UserRoleTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT id, user_id, role_id FROM user_roles WHERE id = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            UserRoleTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
     ...
     *
     * @param \ClanApp\entities\User|ObjectCollection $user The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
