...
abstract class UserRole implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ClanApp\\entities\\Map\\UserRoleTableMap';
    ...
    /**
     * Initializes internal state of ClanApp\entities\Base\UserRole object.
     */
     ...
     * @return $this|\ClanApp\entities\UserRole The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 3; // 3 = UserRoleTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ClanApp\\entities\\UserRole'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ClanApp\entities\UserRole
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ClanApp\entities\UserRole The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ClanApp\entities\UserRole (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ClanApp\entities\UserRole Clone of current object.
     * @throws PropelException
     */
