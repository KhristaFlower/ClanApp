...
abstract class RolePermission implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ClanApp\\entities\\Map\\RolePermissionTableMap';
    ...
    /**
     * Initializes internal state of ClanApp\entities\Base\RolePermission object.
     */
     ...
     * @return $this|\ClanApp\entities\RolePermission The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : RolePermissionTableMap::translateFieldName('RoleId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = RolePermissionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ClanApp\\entities\\RolePermission'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO role_permissions (%s) VALUES (%s)',
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ClanApp\entities\RolePermission
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ClanApp\entities\RolePermission The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ClanApp\entities\RolePermission (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ClanApp\entities\RolePermission Clone of current object.
     * @throws PropelException
     */
