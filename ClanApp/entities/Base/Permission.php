...
abstract class Permission implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ClanApp\\entities\\Map\\PermissionTableMap';
    ...
    /**
     * Initializes internal state of ClanApp\entities\Base\Permission object.
     */
     ...
     * @return $this|\ClanApp\entities\Permission The current object (for fluent API support)
     */
    ...
    public function setTag($v)
    {
        ...
        if ($this->tag !== $v) {
            $this->tag = $v;
            $this->modifiedColumns[PermissionTableMap::COL_TAG] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PermissionTableMap::translateFieldName('Tag', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tag = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PermissionTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\ClanApp\\entities\\Permission'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->rolePermissionsScheduledForDeletion !== null) {
                if (!$this->rolePermissionsScheduledForDeletion->isEmpty()) {
                    \ClanApp\entities\RolePermissionQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PermissionTableMap::COL_TAG)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ClanApp\entities\Permission
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ClanApp\entities\Permission The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PermissionTableMap::COL_TAG)) {
            $criteria->add(PermissionTableMap::COL_TAG, $this->tag);
        }
        if ($this->isColumnModified(PermissionTableMap::COL_NAME)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ClanApp\entities\Permission (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ClanApp\entities\Permission Clone of current object.
     * @throws PropelException
     */
    ...
    public function initRolePermissions($overrideExisting = true)
    {
        ...
        $this->collRolePermissions->setModel('\ClanApp\entities\RolePermission');
    }
    ...
    public function setRolePermissions(Collection $rolePermissions, ConnectionInterface $con = null)
    {
        ...
        $this->rolePermissionsScheduledForDeletion = $rolePermissionsToDelete;
