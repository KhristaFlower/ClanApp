...
use ClanApp\entities\Role;
use ClanApp\entities\RoleQuery;
...
class RoleTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ClanApp.entities.Map.RoleTableMap';
     ...
     */
    const OM_CLASS = '\\ClanApp\\entities\\Role';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ClanApp.entities.Role';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ClanApp\\entities\\Role');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ClanApp\entities\Role) { // it's a model object
