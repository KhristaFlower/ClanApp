...
use ClanApp\entities\RolePermission;
use ClanApp\entities\RolePermissionQuery;
...
class RolePermissionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ClanApp.entities.Map.RolePermissionTableMap';
     ...
     */
    const OM_CLASS = '\\ClanApp\\entities\\RolePermission';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ClanApp.entities.RolePermission';
     ...
     */
    const COL_ID = 'role_permissions.id';

    /**
     * the column name for the permission_id field
     */
    const COL_PERMISSION_ID = 'role_permissions.permission_id';

    /**
     * the column name for the role_id field
     */
    const COL_ROLE_ID = 'role_permissions.role_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'PermissionId', 'RoleId', ),
        self::TYPE_CAMELNAME     => array('id', 'permissionId', 'roleId', ),
        self::TYPE_COLNAME       => array(RolePermissionTableMap::COL_ID, RolePermissionTableMap::COL_PERMISSION_ID, RolePermissionTableMap::COL_ROLE_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'permission_id', 'role_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'PermissionId' => 1, 'RoleId' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'permissionId' => 1, 'roleId' => 2, ),
        self::TYPE_COLNAME       => array(RolePermissionTableMap::COL_ID => 0, RolePermissionTableMap::COL_PERMISSION_ID => 1, RolePermissionTableMap::COL_ROLE_ID => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'permission_id' => 1, 'role_id' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ClanApp\\entities\\RolePermission');
    ...
    {
        $this->addRelation('Permission', '\\ClanApp\\entities\\Permission', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':permission_id',
    1 => ':id',
  ...
  array (
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ClanApp\entities\RolePermission) { // it's a model object
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(RolePermissionTableMap::COL_ID) && $criteria->keyContainsValue(RolePermissionTableMap::COL_ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.RolePermissionTableMap::COL_ID.')');
        }
