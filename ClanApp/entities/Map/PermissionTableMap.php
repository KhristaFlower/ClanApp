...
use ClanApp\entities\Permission;
use ClanApp\entities\PermissionQuery;
...
class PermissionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ClanApp.entities.Map.PermissionTableMap';
     ...
     */
    const OM_CLASS = '\\ClanApp\\entities\\Permission';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ClanApp.entities.Permission';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Tag', 'Name', ),
        self::TYPE_CAMELNAME     => array('id', 'tag', 'name', ),
        self::TYPE_COLNAME       => array(PermissionTableMap::COL_ID, PermissionTableMap::COL_TAG, PermissionTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('id', 'tag', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Tag' => 1, 'Name' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'tag' => 1, 'name' => 2, ),
        self::TYPE_COLNAME       => array(PermissionTableMap::COL_ID => 0, PermissionTableMap::COL_TAG => 1, PermissionTableMap::COL_NAME => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'tag' => 1, 'name' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ClanApp\\entities\\Permission');
        $this->setPackage('ClanApp.entities');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('tag', 'Tag', 'VARCHAR', true, 30, null);
    ...
    {
        $this->addRelation('RolePermission', '\\ClanApp\\entities\\RolePermission', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':permission_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PermissionTableMap::COL_TAG);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ClanApp\entities\Permission) { // it's a model object
